    ...
    <div class="space-y-4">
        <CosmicCard title="Contact Information">
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-2">
                    <div class="w-1/3">
                        ...
                        <select 
                            ...
                            class="w-full px-3 py-2 text-white transition-colors bg-dark-lighter rounded-lg border border-secondary/30 focus:border-secondary focus:outline-none"
                        >
                    ...
                    <div class="w-2/3">
                        <label for="phone" class="block text-sm font-medium text-gray-300">WhatsApp Number <span class="text-primary">*</span></label>
                        <div class="flex">
                            <span class="inline-flex items-center px-3 text-sm text-gray-300 bg-dark-card border border-r-0 border-secondary/30 rounded-l-md">
                                {{ countryPrefix }}
                            </span>
                            <input
                                id="phone"
                                ...
                                type="text"
                                required
                                class="w-full px-4 py-2 text-white transition-colors bg-dark-lighter rounded-r-lg border border-secondary/30 focus:border-secondary focus:outline-none"
                ...
                <div class="p-3 text-xs text-gray-400 bg-dark-lighter rounded-lg">
                    <div class="flex items-start">
                        ...
                        <p>
                            We'll send your order details and receipt to this WhatsApp number. Make sure it's correct.
                        </p>
                    </div>
                </div>
            </div>
...
const { countryCode, countryPrefix, setCountry, formatInternationalNumber } = useCountryCode();
