...
const columns = [
    ...
    },
    {
        ...
        label: "Role",
        format: (value, item) => {
            const role = props.roles.find((r) => Number(r.id) === Number(value));
...
const submitBulkUpdate = async () => {
    if (!bulkData.value.user_roles_id || !bulkData.value.type || !bulkData.value.value || bulkData.value.product_ids.length === 0) {
    ...
    try {
        ...
        if (response.data.success) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: response.data.message || 'Failed to update profit settings',
                background: '#1f2937',
                color: '#fff',
            });
        }
...
<template>
    ...
    <AdminLayout title="Profit Produk">
                        ...
                        <Dropdown align="right" width="48">
                            ...
                            <template #content>
                                ...
                                >
                                    ...
                                    <button
                                        @click="loadPricePreview(item.produk_id)"
        ...
        >
            <div
                class="relative w-full max-w-md mx-4 p-6 border border-gray-700 rounded-lg shadow-lg bg-dark-card"
                @click.stop
            >
        ...
        >
            <div
                class="relative w-full max-w-3xl mx-4 p-6 border rounded-lg shadow-lg border-primary/40 bg-dark-card"
                @click.stop
            ...
            >
                ...
                <div class="relative z-10">
                    ...
                    <div v-if="selectedProductsDetails.length > 0" class="mb-6">
                        ...
                        <div class="p-3 rounded-lg border border-gray-700/50 bg-dark-sidebar/30 max-h-40 overflow-y-auto">
                            <div 
                            ...
                            >
                                ...
                                <button 
                                    @click="selectedProductsDetails.splice(index, 1); bulkData.product_ids.splice(bulkData.product_ids.indexOf(product.id), 1)"
                    ...
                    <form @submit.prevent="submitBulkUpdate" class="space-y-4">
                        ...
                        <div v-if="!bulkData.product_ids.length">
                            ...
                            <span class="text-xs text-gray-400">Hold Ctrl/Cmd to select multiple</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <input
                                    ...
                                    required
                                />
                                <span class="flex items-center justify-center w-10 h-10 text-lg font-bold text-white bg-primary/50 rounded-full">
        ...
        <!-- Price Preview Modal -->
        <Modal :show="showPriceModal" @close="showPriceModal = false" max-width="4xl">
            <div
            ...
            >
                ...
                <div v-else-if="pricePreview && pricePreview.success">
                    ...
                    >
                        <div v-if="pricePreview.product.thumbnail" class="flex-shrink-0">
                            <img
                        ...
                        <div>
                            ...
                            <p v-if="pricePreview.product.brand" class="text-sm text-gray-400">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-700">
                            <thead class="bg-dark-lighter">
                                <tr>
                                    ...
                                    <th
                                        scope="col"
                                        colspan="2"
                                        v-for="(price, index) in pricePreview.pricing[0]?.role_prices"
                                        :key="'role-' + index"
                                        class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-400 uppercase"
                                    >
                                        {{ price.role_name }}
                            ...
                            <tbody class="divide-y divide-gray-700 bg-dark-card">
                                <tr v-for="(service, index) in pricePreview.pricing" :key="'service-' + index">
                                    ...
                                    <template v-for="(price, priceIndex) in service.role_prices" :key="'price-' + priceIndex">
                                        <td class="px-6 py-4 text-sm whitespace-nowrap">
                                            <div
                                                :class="[
                                                    'font-medium',
                                                    price.final_price > service.base_price
                                                        ? 'text-green-400'
                                                        : price.final_price < service.base_price
                                                        ? 'text-red-400'
                                                        : 'text-white'
                                            ...
                                            <div v-if="price.profit_type" class="text-xs text-gray-400">
                                                {{
                                                    price.profit_type === 'percent'
                                                        ? '+' + price.profit_value + '%'
                                                        : 'x' + price.profit_value
                                                }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-white whitespace-nowrap">
                                            ...
                                            >
                                                {{
                                                    price.final_price > service.base_price
                                                        ...
                                                        ? '-' +
                                                        (
                                                            service.base_price - price.final_price
                                                        ).toLocaleString()
                                                        : '0'
                                                }}
                                            </div>
