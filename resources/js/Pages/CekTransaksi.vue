        ...
        <div class="py-8 md:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-10 text-center">
                    <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Transaction Tracker</h1>
                    <p class="text-gray-300">Verify your cosmic purchase journey</p>
                </div>
                ...
                <div v-if="searchResult">
                    <TransactionDetail :transaction="searchResult" :server-time="serverTime" />
                </div>
                
                <!-- Live Transactions -->
                <LiveTransactionsTable :transactions="transactions" :server-time="serverTime" />
            </div>
        </div>
    </GuestLayout>
</template>
